<div class="container h-full mx-auto flex justify-center items-center">
	<div class="space-y-10 text-center flex flex-col items-center">
		...
		<div class="space-y-2">
			<p>Contact me</p>
			<p><a href="mailto:me@erkut.dev" class="code">Send an e-mail</a></p>
			<p>
				<a href="https://calendly.com/ercode-labs/30min" target="_blank" class="code"
					>Arrange a 30 min meeting</a
				>
			</p>
		</div>
	</div>
